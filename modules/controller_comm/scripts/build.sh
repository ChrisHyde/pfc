...
echo "#------------------------------------#"
echo "# controller_comm SOFTWARE BUILD PROCESS #"
echo "#------------------------------------#"
...
compiledependence "controller_comm"

 

echo "5. end"
echo "-----------------------------------"
sudo ln -s -f /usr/local/lib/pfc/libcontroller_commd.so /usr/lib/libcontroller_commd.so
sudo ldconfig
if test "$returnValue" = "0"
then
 echo "build
