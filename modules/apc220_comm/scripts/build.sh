...
echo "#------------------------------------#"
echo "# apc220_comm SOFTWARE BUILD PROCESS #"
echo "#------------------------------------#"
...
compiledependence "apc220_comm"

 

echo "5. end"
echo "-----------------------------------"
sudo ln -s -f /usr/local/lib/pfc/libapc220_commd.so /usr/lib/libapc220_commd.so
sudo ldconfig
if test "$returnValue" = "0"
then
 echo "build
